...
public class Menu extends TestBase
{
    ...
    public void menu(){
        ...
        action.moveToElement(hover).moveToElement(driver.findElement(By.cssSelector("li.hover > .dropdown-menu> a:nth-child(2)"))).click().perform();
        ...
        action.moveToElement(hover2).moveToElement(hover3).moveToElement(hover4).moveToElement(hover5).click().perform();
